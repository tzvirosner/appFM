        ...
        <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
          <div style={CardStyle}
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <div className="mt-10 flex items-center justify-end gap-x-6 lg:justify-end">
                <Link
                    href="#"
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              <h1 className="text-9xl font-bold tracking-tight text-blue-600 sm:text-4xl flex flex-row-reverse">
                AppFM
              </h1>
              <div className="mt-20 flex items-center justify-end gap-x-6 lg:justify-start">
